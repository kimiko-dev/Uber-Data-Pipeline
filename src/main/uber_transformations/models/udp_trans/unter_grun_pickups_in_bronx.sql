...
JOIN {{ source("airbyte_uber_data", "base_num_and_name") }} AS base ON base.base_num = raw.affiliated_base_num
JOIN {{ source("airbyte_uber_data", "taxi_zone_lookup") }} AS t_zone ON t_zone.locationid = raw.locationid
